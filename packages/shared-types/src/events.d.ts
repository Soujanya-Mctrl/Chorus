export type EventType = 'indexing:progress' | 'indexing:complete' | 'indexing:failed' | 'graph:updated' | 'branch:activity' | 'presence:update' | 'security:complete';
...
export type WebSocketEvent = IndexingProgressEvent | IndexingCompleteEvent | IndexingFailedEvent | GraphUpdatedEvent | BranchActivityEvent | PresenceUpdateEvent | SecurityCompleteEvent;
